...
[Take Action](http://www.indivisibleacton.org/take-action.html){:target="_blank"} page. And please don't hesitate to write to us info@indivisibleacton.org if you have ideas to share. We will continue to update with new ideas as we learn about them.
